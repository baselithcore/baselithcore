...
| Signed mandate chain | `core/world_model/mandates.py`, `core/world_model/replay_guard.py` | `IntentMandate`, `CartMandate`, `verify_chain`, `RedisReplayGuard` | [World Model](../core-modules/world-model.md) |
