...
class BackstageProvider:
    ...
    async def to_catalog_info(self, plugin: Plugin) -> dict[str, Any]:
        ...
        (apiVersion: backstage.io/v1alpha1, kind: Component). Body lives in
        ``component_entity`` (module size cap).
        ...
        """
        from .component_entity import build_component_entity

        return await build_component_entity(self, plugin)
