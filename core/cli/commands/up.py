...
from core.cli.commands.env_profiles import ensure_docker_core_env, set_docker_core_image
...
def run_up(image: str | None = None, timeout: int = 300) -> int:
    ...
    try:
        ...
        image_changed = set_docker_core_image(selected_image, DOCKER_ENV_FILE)
    ...
    if image_changed:
        env_changes.append("BASELITH_CORE_IMAGE")
    if env_changes:
